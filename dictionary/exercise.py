# Glossary 
#favorite_languages = {'kim': 'python', 'julius': 'javascript', 'darius': 'kotlin', 'adjetey': 'java'}

#for name, language in favorite_languages.items():
#   if name == 'kim':
#        print(name.title() + " my paddy you for kill " + language.title() + "oh...") 
#    else:
#        print("\n" + language.title() + " is " + name.title() + "'s favorite programming language.")
...
pets = [ {'kind_of_animal': 'cat',
    'owner': 'Johson Nketsia'},
    {'kind_of_animal': 'dog',
        'owner': 'Moses Kudozia'}]
